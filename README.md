...
$\textsf{{\color{white}a }{\color{Maroon}computer scientist}{\color{white} who likes }{\color{ForestGreen}machine learning}{\color{white} and }{\color{NavyBlue}artificial intelligence}{\color{white}.}}$

#### $\textsf{{\color{gray}-- fifth year academia graduate student, with research interests in AI agents, reinforcement learning, and game development.}}$
...
#### $\textsf{{\color{gray}-- specs: RTX 4070, AMD Ryzen 9 7950X3D}}$
